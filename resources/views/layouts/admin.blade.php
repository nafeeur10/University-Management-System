...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/admin-rtl.css') }}" />
    @yield('styles')
</head>
...
<body class="vertical-layout vertical-menu-modern 2-columns navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon feather icon-search"></i></a>
                            <div class="search-input">
                                ...
                                <input class="input" type="text" placeholder="Explore ERU..." tabindex="-1" data-search="template-list">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                  <a class="navbar-brand" href="{{ route("admin.home") }}">
                        ...
                        <h2 class="brand-text mb-0">ERU</h2>
                    </a></li>
                <li class="nav-item nav-toggle">
                  <a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse">
                    <i class="feather icon-x d-block d-xl-none font-medium-4 primary toggle-icon"></i>
                    <i class="toggle-icon feather icon-disc font-medium-4 d-none d-xl-block collapse-toggle-icon primary"></i>
                  </a>
                </li>
            </ul>
        </div>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2020<a class="text-bold-800 grey darken-2" href="javascript:void(0)" target="_blank">ERU,</a>All rights Reserved</span>
        </p>
    </footer>
    <!-- END: Footer-->
