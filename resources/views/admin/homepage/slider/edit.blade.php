        ...
        <form 
            ...
            <div class="form-group">
                ...
                <img 
                    ...
                    src="{{ asset('images/slider/' . $slider->slider_main_image) }}"
                >
            </div>
            ...
            <div class="form-group">
                ...
                <img 
                    ...
                    class="d-block border-0 mt-1"  
                    style="height:100px; width:100px;" 
                    src="{{ asset('images/slider/' . $slider->slider_title_image) }}"
                >
            </div>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', isset($slider) ? $slider->slider_label : '') }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group {{ $errors->has('button_text') ? 'has-error' : '' }}">
                ...
                <input type="text" id="button_text" name="button_text" class="form-control" value="{{ old('button_text', isset($slider) ? $slider->slider_button_text : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('button_link') ? 'has-error' : '' }}">
                ...
                <input type="text" id="button_link" name="button_link" class="form-control" value="{{ old('button_link', isset($slider) ? $slider->slider_button_link : '') }}" required>
