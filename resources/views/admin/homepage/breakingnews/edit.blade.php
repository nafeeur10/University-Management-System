...
<div class="card">
    ...
    <div class="card-body">
        <form 
            action="{{ route('admin.breakingnews.update', $breakingnews->id) }}" 
            method="POST" 
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', isset($breakingnews) ? $breakingnews->news_title : '') }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group {{ $errors->has('name_arabic') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    value="{{ old('name', isset($breakingnews) ? $breakingnews->news_title_arabic : '') }}" 
                    required
                    dir="rtl"
                >
            ...
            <div class="form-group {{ $errors->has('news_link') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="news_link" 
                    class="form-control" 
                    value="{{ old('news_link', isset($breakingnews) ? $breakingnews->news_main_link : '') }}"
                >
            ...
            <div class="form-group {{ $errors->has('breaking_news_start_time') ? 'has-error' : '' }}">
                ...
                <input 
                    type="date" 
                    id="breaking_news_start_time" 
                    name="breaking_news_start_time" 
                    class="form-control" 
                    value="{{ old('breaking_news_start_time', isset($breakingnews) ? $breakingnews->news_start_date : '') }}"
                >
            ...
            <div class="form-group {{ $errors->has('breaking_news_end_time') ? 'has-error' : '' }}">
                ...
                <input 
                    type="date" 
                    id="breaking_news_end_time" 
                    name="breaking_news_end_time" 
                    class="form-control" 
                    value="{{ old('breaking_news_start_time', isset($breakingnews) ? $breakingnews->news_end_date : '') }}"
                >
