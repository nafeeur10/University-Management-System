...
<div class="card">
    ...
    <div class="card-body">
        <form 
            action="{{ route('admin.welcomemessage.store') }}" 
            method="POST" 
            ...
            <div class="form-group {{ $errors->has('welcome_description') ? 'has-error' : '' }}">
                ...
                <input type="text" id="welcome_description" name="welcome_description" class="form-control" required>
            ...
            <div class="form-group {{ $errors->has('welcome_description_arabic') ? 'has-error' : '' }}">
                ...
                <input type="text" id="welcome_description_arabic" name="welcome_description_arabic" class="form-control" required>
