<template>
  <div class="container service">
    ...
    <h4>
      Nuclear Power Stations Engineering Department Major Staff
    </h4>
    <br><br>
    <div class="row">
          <div class="col-sm-12">
            <div class="row">
                    <div class="col-sm-3">
                      <h3>Aly Abdallah Saeed</h3>
                      <button class="btn-staff" type="submit" onclick="window.open('storage/img/AliAbdallah.pdf')">Assistant Lecturer</button>
                    </div> 
