<template>
  <div class="container service">
    <h1>BOARD MEMBERS</h1>
    <h6>
      Faculty of Management, Professional Technology and Computers Major Staff
    </h6>
    <br><br>

    <h3>Pro. Dr. Al Tahra El Sayed HEMAYA</h3>
                      
    <button class="btn-staff" type="submit" onclick="window.open('storage/img/dr-eltahraCV.pdf')">Faculty Dean</button>
