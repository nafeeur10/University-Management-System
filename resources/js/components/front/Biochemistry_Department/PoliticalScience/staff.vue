          ...
          <div class="col-sm-12">
            <div class="row">
                    <div class="col-sm-3" style="">
                      <h3>Dr. Ahmed Zakaria Elbasousy</h3>
                      <button class="btn-staff" type="submit" onclick="window.open('storage/img/Ahmed-ElbassosyCV.pdf')">PROFESSOR</button>
                    </div>                                         
          </div>
</div>
</div>
