    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class=lip >
                    <div class="back">
                        <h3>The Vision of the Construction Engineering Program</h3>
                        The Construction Engineering program at the Faculty of Engineering at the Egyptian Russian University seeks to be in a prestigious position among Construction Engineering programs in Egyptian, Arab and international engineering faculties and to be one of the development elements of the Egyptian-Russian scientific relationships.

                        <h3>The Mission of the Construction Engineering Program</h3>
                        ...
                        <div class="right_holder">
                            <button class="btn life" type="submit" onclick="window.open('storage/img/Construction-Engineering.pdf')">Courses</button>
                            <button class="btn us" type="submit" onclick="window.open('storage/img/organizational-structure-construction.pdf')">Organizational Structure</button>
                        </div>
                    </div>
                </div>
            </div>
